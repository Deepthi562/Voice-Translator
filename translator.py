#firstly we will import all the modules required
#1. playsound: This module is used to play sound in Python

pip install playsound

#2. Speech Recognition Module: It is a library with the help of which Python can recognize the command given.
...
# after installing , now we will import necessary modules
...
# a dictionary tuple which matches language with code
